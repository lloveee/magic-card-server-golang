...
func main() {
	...
	charData := [][]any{
		...
		{"血魔", "xuemo", 90, 100, 0, "无", "", "", ""},
		{"反伤者", "fanshang", 95, 100, 0, "无", "", "", ""},
		{"建造者", "jianzao", 90, 100, 0, "无", "", "", ""},
	}
	...
	paramData := []any{
		...
		"sep",
		// ── 反伤者 ──
		paramRow{"反伤者", "反弹层数上限", 5, "反伤护盾可叠加的最大层数"},
		paramRow{"反伤者", "普通技能消耗", 10, "叠加1层反弹护盾消耗的能量"},
		paramRow{"反伤者", "强化技能消耗", 15, "技能免疫消耗的能量"},
		paramRow{"反伤者", "强化技能点数阈值", 3, "使用强化技能需要的最低点数"},
		paramRow{"反伤者", "强化免疫阶段数", 3, "技能免疫持续的阶段数"},
		paramRow{"反伤者", "解放技能消耗", 50, "解放技能消耗的能量"},
		paramRow{"反伤者", "解放技能点数阈值", 25, "触发解放需要的最低技能牌点数"},
		paramRow{"反伤者", "解放免疫阶段数", 10, "全免疫+反弹持续的阶段数（约2回合）"},
		"sep",
		// ── 建造者 ──
		paramRow{"建造者", "工人基础效率", 1, "每个小人每阶段建造的进度（基础值）"},
		paramRow{"建造者", "一层房效率加成", 2, "超过1层房子时每层房子增加的工人效率"},
		paramRow{"建造者", "二层房减伤", 2, "超过2层房子时每层房子增加的减伤值"},
		paramRow{"建造者", "三层房回血", 5, "达到3层房子时每层房子每回合回血量"},
		paramRow{"建造者", "房子减半伤害阈值", 20, "单次伤害超过此值时房子减半"},
		paramRow{"建造者", "解放最低房子数", 5, "触发解放需要的最低房子层数"},
		paramRow{"建造者", "解放最低点数", 20, "触发解放需要的最低技能牌点数"},
		paramRow{"建造者", "解放最高点数", 25, "触发解放的最高技能牌点数"},
	}
	...
	fieldData := [][]any{
		{"空旷之地", "clear", "", "", 0, "", "", ""},
		{"方片之境·实", "diamond_real", "是", "", 0, "", "", ""},
		{"方片之境·虚", "diamond_void", "", "", 0, "是", "", ""},
		{"黑桃之境·实", "spade_real", "", "", 1, "", "", ""},
		{"黑桃之境·虚", "spade_void", "", "", 2, "", "", ""},
		{"混沌之域", "chaos", "", "是", 0, "", "", ""},
		{"回响之地", "echo", "", "", 0, "", 1, ""},
